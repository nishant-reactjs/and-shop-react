...
const PrivacyPolicy = () => {
  return (
    <>
      <Helmet>
        <title>AND SHOP - privacy & Policy..</title>
      </Helmet>
              ...
              <div className="hero-text">
                ...
                <nav aria-label="breadcrumb">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item items">Privacy Policy</li>
                  </ol>
                </nav>
              </div>
            </div>
              ...
              <div className="privacy_content">
                ...
                <div className="privacy_policy_text">
                  ...
                  <p>
                    ...
                    see if you are using it. The service privacy policy is
                    available. After approval of your comment, your profile
